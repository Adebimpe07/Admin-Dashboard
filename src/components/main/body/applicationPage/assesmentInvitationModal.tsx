...
export const AssesmentInvitationModal = () => {
  ...
  return (
    <form className="flex flex-col gap-6">
      ...
      <p className="text-[#514747] text-sm text-center">You are about to invite the selected applicant for assessment, kindly click the button below to confirm this action</p>
