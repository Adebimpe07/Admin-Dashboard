...
export const ShortlistModal = ({ rowdetail, setSubAdminModal }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (checked) {
            ...
            var config: AxiosRequestConfig = {
                method: "post",
                url: rowdetail.url + `/set-shortlisted`,
                headers: {
    ...
    return (
        <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-6">
            ...
            <p className="text-[#514747] text-sm text-center">
                You are about to shortlist the selected applicant, kindly click
                the button below to confirm this action
            </p>
            <Checkbox
                checked={checked}
