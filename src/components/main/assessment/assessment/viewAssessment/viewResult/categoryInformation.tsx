                    ...
                    return (
                        <div key={index}>
                            <div className="text-gray-500 font-semibold">
                                Category name:
                                <span className="text-gray-700 font-base capitalize p-4">
                            ...
                            <div className="text-gray-500 font-semibold">
                                Allocated Time:{" "}
                                <span className="text-gray-700 font-base capitalize p-4">
                                    {element?.category?.test_duration}
                                </span>
                            </div>
                            <div className="text-gray-500 font-semibold">
                                Score:{" "}
                            ...
                            <div className="text-gray-500 font-semibold">
                                Percentage Score:{" "}
                                <span className="text-gray-700 font-base capitalize p-4">
                                    {element?.percentage_mark.toFixed(2)} %
                                </span>
                            </div>
                            <div>
                                <h1 className="font-bold text-gray-600 text-lg pt-4">
                                    Session Details.
                                </h1>
                                <div className="text-gray-500 font-semibold">
                                    Browser:{" "}
                                ...
                                <div className="text-gray-500 font-semibold">
                                    Full Screen Active:{" "}
                                    <span className="text-gray-700 font-base capitalize p-4">
                                        {element?.session?.full_screen_active}{" "}
                                    </span>
                                </div>
                                <div className="text-gray-500 font-semibold">
                                    Enabled Webcam:{" "}
                                    <span className="text-gray-700 font-base capitalize p-4">
                                        {element?.session?.enable_webcam}{" "}
                                    </span>
                                </div>
                            </div>
                            <div className="flex  justify-between">
                                <div className="text-gray-500 font-semibold">
                                    ...
                                    <span className=" font-base capitalize p-4">
                                        {element?.open_ended_questions.length}{" "}
                                    </span>
                                </div>
